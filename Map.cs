...
namespace DGD203_2
{
    public class Map
    {
        ...
        {
            _locations = new Location[8]; // Adjust the array size based on the number of locations
            ...
            Vector2 caveLocation = new Vector2(3, 2);
            Location cave = new Location("a Mysterious", LocationType.Cave, caveLocation);
            _locations[6] = cave;

            Vector2 thirdCombatLocation = new Vector2(3, -1);
            Location thirdCombat = new Location("Third Combat", LocationType.Combat, thirdCombatLocation);
            _locations[7] = thirdCombat;
